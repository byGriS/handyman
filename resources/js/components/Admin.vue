    ...
    <div class="container">
        <nav class="row">
            ...
            <router-link
                ...
                :class="{
                    adminNavSelected: this.$route.name == 'completedWorks'
                }"
            ...
            <router-link
                :to="{ name: 'heating' }"
                class="adminNavItem col-sm-2"
                :class="{ adminNavSelected: this.$route.name == 'heating' }"
                >Нагрев</router-link
            >
        </nav>
        <hr />
...
.adminNavItem:hover {
    background: rgb(204, 240, 209);
    box-shadow: 0 4px 8px rgb(181, 192, 197, 0.8);
}
.adminNavSelected {
    background: rgb(176, 217, 233);
}
.row {
    margin: 0px;
}
